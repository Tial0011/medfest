    ...
    <nav class="navbar" data-navbar aria-label="Primary">
      <div class="container navbar__inner">
        <a class="navbar__logo" href="${Utils.resolveHref(root, "index.html")}">
          <img class="navbar__brand-image" src="${Utils.resolveHref(root, "assets/images/Logos/medfest-logo.webp")}" alt="${name} V - Home" width="132" height="72" fetchpriority="high" decoding="async" />
        </a>
